...
/* harmony import */ var _modules_loadContent__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/loadContent */ "./src/js/modules/loadContent.js");
/* harmony import */ var _modules_getStyleBlocks__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/getStyleBlocks */ "./src/js/modules/getStyleBlocks.js");
...
/* harmony import */ var _modules_showPicture__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/showPicture */ "./src/js/modules/showPicture.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_2__["default"])('.accordion-heading');
  ...
  var inp = document.querySelector('.input-wrapper > [name="name"]');
  var pos = 0;
  ...
  Object(_modules_getStyleBlocks__WEBPACK_IMPORTED_MODULE_7__["default"])('.button-styles', '.styles .row');
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_8__["default"])('#size', '#material', '#options', '.promocode', '.calc-price');
  Object(_modules_portfolio__WEBPACK_IMPORTED_MODULE_9__["default"])('.portfolio-menu li', '.portfolio-block');
  Object(_modules_showPicture__WEBPACK_IMPORTED_MODULE_10__["default"])();
...
/* harmony import */ var _service_workWithServer__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../service/workWithServer */ "./src/js/service/workWithServer.js");
...
function dragAndDrop() {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      if (input.closest('.main')) {
        ...
        Object(_service_workWithServer__WEBPACK_IMPORTED_MODULE_8__["default"])('assets/server.php', formData).then(function (res) {
  ...
  ['dragleave', 'drop'].forEach(function (eventName) {
    fileInputs.forEach(function (input) {
      input.addEventListener(eventName, function () {
        return unhighlightElement(input);
      });
    });
  });
}
...
var forms = function forms(state) {
  ...
  function clearInputs() {
    ...
    inputsFileType.forEach(function (item) {
  ...
  forms.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      Object(_service_workWithServer__WEBPACK_IMPORTED_MODULE_8__["default"])(adress, formData).then(function (data) {
...
/***/ "./src/js/modules/getStyleBlocks.js":
/*!******************************************!*\
  !*** ./src/js/modules/getStyleBlocks.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getStyleBlocks; });
...
function getStyleBlocks(trigger, wrapper) {
  ...
  /*#__PURE__*/
  function () {
    function UseData(src, title, type) {
      _classCallCheck(this, UseData);
  ...
  btn.addEventListener('click', function () {
    getData('assets/db2.json').then(function (data) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return loadContent; });
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);

function loadContent(trigger, content) {
  var btn = document.querySelector(trigger),
...
function modal() {
  ...
  function calcScrollBar() {
    ...
    var scrollBar = div.offsetWidth - div.clientWidth;
    div.remove();
    return scrollBar;
  }
  /* setTimeout(() => {
      ...
      document.querySelectorAll('[data-modal]').forEach(item => {
          if (getComputedStyle(item).display !== 'none') {   //если тут использовать style, то возьмутся изначальные стили, а не которые были применены из-за действий пользователя
              display = 'block';                             // поэтому используем getComputedStyle
          } 
      });
      if (!display) {
...
function portfolio(menuElemSelector, portfolioBlockSelector) {
  var menuElem = document.querySelectorAll(menuElemSelector),
...
var scrolling = function scrolling(upSelector) {
  ...
  var links = document.querySelectorAll('[href^="#"]'),
      // Получили все ссылки, которые начинаются с: '#'. (^- каретка, она проверяет: начинается ли строка с опред. символов)
  speed = 0.10;
  links.forEach(function (link) {
    link.addEventListener('click', function (event) {
      event.preventDefault();
      var widthTop = document.documentElement.scrollTop,
          // Получили кол-во px сверху, т.е сколько проскролено
      hash = this.hash,
          // Получает, по сути, id эл. на который кликнули
      toBlock = document.querySelector(hash).getBoundingClientRect().top,
          //Получает знач, на которое переместились относительно верха страницы(1650, 5000, 3000 - знач в px)
      start = null;
      requestAnimationFrame(step);

      function step(time) {
        // Время, прошедшее с захода на стр
        if (start === null) {
          start = time;
        ...
        var progress = time - start,
            // Получает время за которое была выполнена анимация
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return showPicture; });
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
...
function showPicture() {
  ...
  sizesBlock.forEach(function (item, i) {
    item.addEventListener('mouseenter', function () {
      var innerParagraphs = item.querySelectorAll('p'),
          innerImg = item.querySelector('img');
      innerImg.src = "assets/img/sizes-".concat(i + 1, "-1.png");
      innerParagraphs.forEach(function (el) {
    ...
    item.addEventListener('mouseleave', function () {
      var innerParagraphs = item.querySelectorAll('p'),
          innerImg = item.querySelector('img');
      innerImg.src = "assets/img/sizes-".concat(i + 1, ".png");
      innerParagraphs.forEach(function (el) {
        el.style.display = 'block';
      });
    });
...
/***/ "./src/js/service/workWithServer.js":
/*!******************************************!*\
  !*** ./src/js/service/workWithServer.js ***!
  \******************************************/
/*! exports provided: default */
